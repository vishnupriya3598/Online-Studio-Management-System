...
}else
{
 if(isset($_POST['login'])){
  $sql = "SELECT * FROM admin_login WHERE username='".$_POST['user_name']."' AND password='".$_POST['password']."'";
      ...
      <form class="form-horizontal" method="post">
        ...
        <div class="form-group">        
          <div class="col-sm-offset-2 col-sm-10">
            <input type="submit" class="btn btn-success" value="Admin Login" name="login">
          </div>
        </div>
      </form>
    </div>
